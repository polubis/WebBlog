...
duration: 5
description: Comprehensive article that guides developers through the process of enabling and customizing dark mode in a Gatsby project using the popular utility-first CSS framework, Tailwind CSS. The article begins by explaining the concept of dark mode and its benefits, highlighting its impact on user experience and accessibility.
---
...
<Summary label="Conclusions and next steps">
  ...
  <M>
    In the next lesson, we'll add <B>commitlint</B> to our project and we'll
    protect developers from adding bad-looking <B>commits</B>.
  </M>
</Summary>
