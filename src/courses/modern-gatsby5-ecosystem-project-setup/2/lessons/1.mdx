...
duration: 4
description: We'll use Gatsby5 CLI to set up a project with TypeScript, MD | MDX syntax, Google Analytics support, and automatic site maps creation, we'll add a manifest file and support for the GatsbyImage component.
---
...
<Summary label="Conclusions and next steps">
  ...
  <M>
    ...
    our project to achieve great developer experience in IDE.
  </M>
</Summary>
