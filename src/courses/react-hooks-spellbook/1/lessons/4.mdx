...
description: We'll write one liner hook that will remove popular warning on Next.js or Gatsby that makes developer scarry. We'll investigate te source of the warning and we'll check why it occurs.
duration: 3
---
