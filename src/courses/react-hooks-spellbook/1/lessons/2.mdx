...
<Section>
  ...
  />
  <Code lang="tsx" mode="static" description="These functions blocks the possibility of passing bad parameters - they're type-guards!">{`import { useStepper } from './use-stepper';
...
<Section>
  ...
  <Code
    mode="dynamic"
    lang="ts" description="Types for useStepper" src="https://raw.githubusercontent.com/polubis/Dream-stack-for-React-dev/main/system/libs/figa-hooks/src/lib/use-stepper/defs.ts" linesCount={47} />
  <Code
    mode="dynamic"
    lang="tsx" description="Implementation of useStepper" src="https://raw.githubusercontent.com/polubis/Dream-stack-for-React-dev/main/system/libs/figa-hooks/src/lib/use-stepper/use-stepper.tsx" linesCount={75} />
  <Code
    mode="dynamic"
    lang="tsx" description="Tests for useStepper" src="https://raw.githubusercontent.com/polubis/Dream-stack-for-React-dev/main/system/libs/figa-hooks/src/lib/use-stepper/use-stepper.test.tsx" linesCount={106} />
  <Code
    mode="dynamic"
    lang="ts" description="Re-exports" src="https://raw.githubusercontent.com/polubis/Dream-stack-for-React-dev/main/system/libs/figa-hooks/src/lib/use-stepper/index.ts" linesCount={2} />
</Section>
