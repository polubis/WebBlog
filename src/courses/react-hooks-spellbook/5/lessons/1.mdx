...
description: We'll check how to show/hide scroll programmatically and by default. After this article, you'll have a powerful useScrollHide hook to work with Modals and similar components.
duration: 5
---
