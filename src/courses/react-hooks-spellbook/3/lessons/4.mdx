...
<Section>
  ...
  <Snippet description="Type definitions for our useIntersectionObserver hook - defs.ts">{`
...
export type { IntersectionObserverConfig, IntersectionObserverReturn };`}</Snippet>
  <M>
  ...
  <Snippet description="Implementation located inside use-intersection-observer.ts">{`
  import type {
...
<Section>
  ...
  <Snippet description="Tests which will prevent regression - use-intersection-observer.test.tsx">{`
