...
description: We'll create a hook called useClickOutside to detect the moment when the user clicks outside a particular HTML element node. It may be useful to close Modal or Sidebar components in your app.
duration: 6
---
...
<Prelude label="Understanding the use cases for the useClickOutside hook">
  ...
  src="https://drive.google.com/uc?export=view&id=1r26NYiUu7oWaLUsj8UHAzvXTyRuX-MeR"
/>
...
description="TypeScript protection"
  src="https://drive.google.com/uc?export=view&id=1SIL9Dp2XiP2UZ21QAv9R7P4mHCKRHHlN"
/>
