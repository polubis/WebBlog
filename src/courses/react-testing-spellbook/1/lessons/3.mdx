...
duration: 2
description: Let's understand the testing syntax by providing metaphors and referring to real life. We'll understand the concepts of testing.
---
...
<Section>
  ...
  <Code mode="static" lang="markdown" description="For humans">
    {`
...
6. Did the pizza taste good for 90% customers?
  ...
  <Code mode="static" lang="ts" description="For computers">
    {`
