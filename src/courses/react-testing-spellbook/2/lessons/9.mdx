...
<Section>
  ...
  <M>
    Take a look at the following code snippet, in which we try to get a{" "}
    <B>url</B> to our <B>API</B> with <B>getUrl</B> function.
  </M>
  <Snippet>
    {`
...
<Section>
  ...
  <Hint hasBg>
    You can check how <B>fixtures</B> works under{" "}
    <A
      outside
...
<Summary>
  <M>
    We've practiced mocking environment variables and reuse of logic in tests
