...
description: We'll inject the Jest environment functions into our fixtures and with the dependency injection pattern, we'll reduce the amount of code and responsibilities from developers during test creation.
duration: 4
---
