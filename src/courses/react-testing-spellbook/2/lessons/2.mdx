...
duration: 4
description: Understanding the basics of unit testing with generic functions as an example. Let's write several tests and learn unit tests!
---
...
<Section>
  ...
  <L>
    <Li>Work is doubled in every rename attempt</Li>
    <Li>The focus is on implementation - not on the purpose of something</Li>
    <Li>Test descriptions are not clear</Li>
    <Li>Typos risk</Li>
  </L>
  <M>
