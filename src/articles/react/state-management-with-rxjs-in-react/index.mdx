...
description: Let's check how state management implemented with the RxJs library works in React. We'll implement a simple state manager using reactive patterns.
readTime: 10
...
<Section>
  ...
  <L>
    ...
    <Li>Reusability</Li>
    <Li>Option to easily migrate to other technology</Li>
    <Li>Easy to replace the logic</Li>
  </L>
  <M>
