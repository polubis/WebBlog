...
<Prelude>
  <M>
    Form management sometimes can be tricky. During the development of a simple
    login form, of course, there is no option to have problems. Anyway, problems
    occur when there is a requirement for{" "}
    <B>multi-step form, dynamic fields, async validation or customization</B>.
  </M>
  <M>
    Your first choice will be a library. It's not bad, generally, that's a good
    idea. However, if you need customization, more advanced features or fix
    frustrating bugs - there is a headache.
  </M>
  <M>
    In addition, there is a risk connected with library usage. They often start
    to be not supported, then you need to migrate to other technologies and libs
    uses other libs with code that is usually useless for you.
  </M>
  <M>
  ...
  <Hint hasBg>
    Remember all custom solutions require additional maintenance. Use stuff like
    that wisely.
  </Hint>
</Prelude>
...
<Section>
  ...
  <M>
    ...
    tests, you can break your previous features.
  </M>
  <Code
  ...
  />
  <Hint hasBg>
    Please check the tests implementation{" "}
    <A
...
<Section>
  ...
  <M>
    ...
    take it easy 👽. Green means it works.
  </M>
  <Code
...
<Summary>
  ...
  <M>
    ...
    techniques which you are using. Check if your project fits into solutions
    like this before you use them.
  </M>
  <M>
