...
// Now our all domain interfaces are inside models.ts file. We're using alias "@models" to import them.
...
<Summary>
  ...
  <M>
    ...
    difference. Of course, everything in moderation and calculation of profits
    and losses.
  </M>
  <M>
