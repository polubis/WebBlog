...
<Section>
  ...
  <M>
    ...
    the supported storage and let's add a <B>storage</B> function skeleton.
  </M>
  <Snippet>
    {`
...
<M>
  ...
  that reads the "latest" values. If it was variable - the value would always be
  the same - initially adjusted keys (empty array).
</M>
...
<Summary>
  ...
  <M>
    ...
    , you will find animated code to guide you through the implementation
    process. You can play with it and suggest changes.
  </M>
  <M>
