...
<Prelude>
  ...
  <Hint hasBg>
    If you are lazy and want final code - you can get it in the following
    <A
...
`}</Snippet>
  ...
  <M>
    We have to do repetitive logic every time - parsing when reading and
    writing.
  </M>
  <Snippet>
    {`
...
<Section>
  ...
  <M>
    ...
    the supported storages and let's add a <B>storage</B> function skeleton.
  </M>
  <Snippet>
    {`
...
`}
  ...
  <Hint hasBg>
    If you want to understand what test-driven development is, want to explore
    the secrets of testing, then I invite you to
    <A
      outside
      href="/articles/quick-wins/improving-code-that-was-not-written-by-us/"
    >
      this article
    </A> and the following <A outside href="/courses/react-testing-spellbook/">
      course
    </A>.
  </Hint>
...
<M>
  ...
  that reads the "latest" values. If it was a variable - the value would always
  be the same - initially adjusted keys (empty array).
</M>
