...
<Section>
  ...
  <M>
    ...
    <B>reduce</B> dorzucają i zdejmują anonimowe funkcje ze stosu wywołań przy
    każdej iteracji, więc prawdopodobnie to złożyło się na ich gorszy wynik w
    porównaniu do <B>while</B> czy <B>for</B>.
  </M>
  <Hint hasBg>
    Nie ma nic za darmo... Zyskując na czytelności kodu tracimy na szybkości
    działania.
  </Hint>
  <Hint hasBg>
    Takie porównywanie czasu sprawdzi się o wiele bardziej w przypadku dwóch
    różnych rozwiązań (algorytmów).
  </Hint>
</Section>
