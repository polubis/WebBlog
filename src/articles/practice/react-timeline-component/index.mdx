...
description: Let's implement the timeline component in React. We'll calculate styles in real time and we'll memoize calculations to save some performance.
readTime: 11
...
<Section>
  ...
  <Img
    src="https://drive.google.com/uc?export=view&id=1enpGYugSPJwu9h8gTe1ayzVnJ3Tzng3j"
