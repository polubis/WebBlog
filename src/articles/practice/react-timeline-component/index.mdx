...
description: Discover the process of creating a react timeline component and check out the sites that will help you increase your developer skills.
readTime: 20
...
<Prelude>
  <M>
    In the frontend world, you need to practice so that you don't lose fluidity
    in writing code. I like to pick a specific problem and solve it. It doesn't
    have to be big, as long as it's a challenge.
  </M>
  <M>
  ...
  <Hint hasBg>
    Someone wise 🤓 once said - "If you are not moving forward you are moving
    backward".
  </Hint>
  <Hint hasBg>
...
<Section>
  ...
  <Img
    src="https://raw.githubusercontent.com/polubis/WebBlog/React-timeline-component/src/articles/practice/react-timeline-component/demo1.gif"
...
<Section>
  <XL>2. Legend</XL>
  <M>
    Before you start work, determine which elements your component will consist
    of. This is helpful later when naming variables.
  </M>
  <Img
    src="https://raw.githubusercontent.com/polubis/WebBlog/React-timeline-component/src/articles/practice/react-timeline-component/legend1.png"
...
<Section>
  ...
  />
  <M>
    Your component will also take a <B>setup</B> which specifies sizes and
  ...
  />
  <M>
    Finally, an example of such an object that you can pass to a component, but
    it is not required. The component will use the default implementation.
  </M>
  <Code
...
<Section>
  ...
  <M>
    ...
    configurations and test manually if it works as expected.
  </M>
</Section>
...
<Section>
  ...
  />
  <Img
    src="https://raw.githubusercontent.com/polubis/WebBlog/React-timeline-component/src/articles/practice/react-timeline-component/container.png"
...
<Section>
  ...
  />
  <Img
    src="https://raw.githubusercontent.com/polubis/WebBlog/React-timeline-component/src/articles/practice/react-timeline-component/lineX.png"
...
<Section>
  ...
  <M>
    ...
    <B>group index, setup object and orientation</B>.
  </M>
  <Code
  ...
  <Img
    src="https://raw.githubusercontent.com/polubis/WebBlog/React-timeline-component/src/articles/practice/react-timeline-component/markers.png"
...
<Section>
  ...
  <M>
    Analogous to markers, you must calculate the distance from the left side and
    the top/bottom depending on the orientation.
  </M>
  <M>
    In addition, you also need the height, which will vary depending on the
    several items in the group.
  </M>
  <Code
  ...
  />
  <Img
    src="https://raw.githubusercontent.com/polubis/WebBlog/React-timeline-component/src/articles/practice/react-timeline-component/line-y.png"
...
<Section>
  ...
  <M>
    This is the final step. All you need to do is create a <B>GroupItem</B>{" "}
...
<Section>
  <XL>Bonus!</XL>
  <M>
    If you would like to start to refactor or improve performance - you can use{" "}
    <B>jest snapshot testing</B> technique.
  </M>
  <M>
    Just create file <B>Timeline.test.tsx</B> and add this code.
  </M>
  <Code
  ...
  <Img
    src="https://raw.githubusercontent.com/polubis/WebBlog/React-timeline-component/src/articles/practice/react-timeline-component/snapshots.png"
