...
<Section>
  ...
  <Image
    rolled
    src="https://raw.githubusercontent.com/polubis/Snippets/main/storybook.gif"
...
<Section>
  ...
  <Image
    rolled
    src="https://raw.githubusercontent.com/polubis/Snippets/main/chromatic.gif"
...
<Section>
  ...
  <L>
    <Li>Developer changes implementation</Li>
    <Li>PR is raised to main</Li>
    <Li>Chromatic builds components and requests review</Li>
    <Li>Review is accepted -> you can merge into main</Li>
  </L>
  <M>
  ...
  <L>
    ...
    <Li>Change component implementation which indicates UI</Li>
    <Li>Raise PR to main</Li>
    <Li>Check if build is created</Li>
  </L>
  <Image
    rolled
    src="https://raw.githubusercontent.com/polubis/Snippets/main/final.gif"
