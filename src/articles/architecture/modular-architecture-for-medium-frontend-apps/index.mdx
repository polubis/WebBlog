...
<Section>
  ...
  <L>
    ...
    <Li>There is a small amount of shared state across components</Li>
    <Li>Application is small/medium size</Li>
    <Li>Your team is familiar with these architectural concepts</Li>
  </L>
</Section>
