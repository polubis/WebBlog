...
description: Explanation of Proxy and Reflect API's that JavaScript offers. Let's investigate the typical use cases of each and understand how they work!
readTime: 5
...
<Section>
  ...
  <L>
    <Li>by data: '1 + (2 * 3)' - is a string!</Li>
    <Li>by code: '1 + (2 * 3)' - is it a code snippet? Then it is 7!</Li>
  </L>
  <M>
