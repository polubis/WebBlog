const summary_footer_id = "summary-footer"
const scroll_to_key = "scrollTo"
const summary_footer_config = {
  author_section: 92,
  author_section_margin_bottom: 32,
  observe_me_margin_bottom: 20,
  observe_me_height: 340,
  comments_section_height: 244,
...
export { summary_footer_config, scroll_to_key, summary_footer_id }
